...
The `Find Match` button will appear when the list is fully filled. You can click this button to find a list of matching donors with this patient in ORGANice. Note that the Find Match button will only appear on the Patient form.
