...
Simply type `help` in the Command Box and press kbd:[Enter].
You will see a link to our user guide given on a pop-up window.
You may click on this link to guide you through how to use ORGANice.
Click the kbd:[x] button to close the window and return to the default display.
// end::help[]
