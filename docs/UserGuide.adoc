...
Simply use the `help` command and you see a link to our user guide given in a pop-up window.
You may click on this link to see our user guide for more information on how to use ORGANice.

To exit the window, click the 'x' button found near the top of the window to close it and return to the default display.
// end::help[]
...
**In addition, there are attributes that cannot be edited.** These include:

* NRIC
+
* Type

You may want to refer to <<List of Attributes>> to see what attributes are applicable to each type of person in ORGANice.
// end::edit[]
...
You can refer to <<Glossary>> for more information on compatibility rate.
