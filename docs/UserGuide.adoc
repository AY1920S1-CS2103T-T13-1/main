...
You can use the `find` command to search for persons whose attributes match your input keywords. +
...
As seen from Figure 12, `find n/Alice Carl Ellie t/doctor donor` displays both `Alice Pauline` and `Elle Meyer`.
