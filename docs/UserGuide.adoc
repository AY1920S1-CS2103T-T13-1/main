...
4.  Double-click the file to start the application. The application should appear in a few seconds.
...
This section will introduce you to the list of features and commands
