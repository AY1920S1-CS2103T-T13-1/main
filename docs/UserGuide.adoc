...
* In cases where patients have the **same priority**, they will be **further sorted in descending number of matched donors they have**. +

* If they have the **same priority and number of matched donors**, they will be **further sorted based on their names in alphabetical order**.
