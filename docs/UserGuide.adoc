...
Refer to the figure below to see how the resulting screen will look like.

image::addForm.png[width="790"]

If you want to add a patient named "John Doe", type `John Doe` and then press kbd:[Enter].
After entering the name, the patient's name will be displayed on the form as seen below and the progress bar will increase indicating your progress in filling up the form.
