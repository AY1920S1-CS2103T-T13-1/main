...
*** Authored the implementations and use cases of the 'List' and 'Sort' features in the Developer Guide, and amended the Model Class Diagram. (Pull requests https://github.com/AY1920S1-CS2103T-T13-1/main/pull/131[#131],
...
The following is a Model Class Diagram that I have updated in order to reflect the changes made to the application:
