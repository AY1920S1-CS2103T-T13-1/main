...
image::Ui.png[width="790" height="500"]
...
** What it does: Allows user to add a person by typing one attribute one at a time.
** Justification: This feature improves the product significantly because a user can ensure that he/she enter the person's attributes correctly
