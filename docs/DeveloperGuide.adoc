...
issues the command `edit ic/S5678908D n/Mr Lim`.

.Component interactions for `edit ic/S5678908D n/Mr Lim` command
...
.Interactions Inside the Logic Component for the `edit ic/S5678908D n/Mr Lim` Command
