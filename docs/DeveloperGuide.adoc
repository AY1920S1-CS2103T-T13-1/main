...
== Introduction
Welcome to ORGANice! This is an organ matching desktop application that is specifically designed with fast typing
hospital administration staff in mind. This developer guide is meant for developers who would like to understand the
...
This section explains the interactions between the different architecture components through an example.
...
Figure 4 below depicts the classes in the UI component and their relationships to each other.
It will be referred to in our explanation of the UI component design.
...
Figure 5 below depicts the classes in the Logic component and their relationships to each other.
It will be referred to in our explanation of the Logic component design.
