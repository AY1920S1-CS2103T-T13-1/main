...
This command also make changes to the `Status` of the patient and donor.
`Status` is an attribute of `Patient` and `Donor`. however, it cannot be edited or added by users.
