...
public class FormAnimation {
    ...
    /**
     * Animation for removing text in the form.
     */
    public static void removeTextAnimation(MainWindow mainWindow, String commandText, String formField) {
        final Animation animation = new Transition() {
            {
                setCycleDuration(Duration.millis(750));
            }
            ...
            protected void interpolate(double frac) {
                ...
                case FormField.NAME:
                    mainWindow.getForm().setName(commandText.substring(n-1, n));
                    break;

                case FormField.NRIC:
                    mainWindow.getForm().setNric(commandText.substring(n-1, n));
                    break;
