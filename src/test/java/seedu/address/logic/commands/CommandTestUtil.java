...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_PERSON_AMY = "Amy Bee";
    public static final String VALID_NAME_PERSON_BOB = "Bob Choo";
    public static final String VALID_NAME_PATIENT_IRENE = "Irene";
    public static final String VALID_NAME_DONOR_JOHN = "John";
    public static final String VALID_PHONE_PERSON_AMY = "11111111";
    public static final String VALID_PHONE_PERSON_BOB = "22222222";

    public static final String VALID_PHONE_PATIENT_IRENE = "85355255";
    public static final String VALID_PHONE_DONOR_JOHN = "81230942";
    public static final String VALID_NRIC_PERSON_AMY = "S1111111A";
    public static final String VALID_NRIC_PERSON_BOB = "G2222222B";
    public static final String VALID_NRIC_PATIENT_IRENE = "S1111111A";
    public static final String VALID_NRIC_DONOR_JOHN = "T1312123P";
    public static final String VALID_TYPE_PERSON_AMY = "doctor";
    public static final String VALID_TYPE_PERSON_BOB = "patient";
    ...
    public static final String VALID_AGE_PERSON_BOB = "21";
    public static final String VALID_AGE_DONOR_JOHN = "60";

    public static final String NAME_DESC_PERSON_AMY = " " + PREFIX_NAME + VALID_NAME_PERSON_AMY;
    public static final String NAME_DESC_PERSON_BOB = " " + PREFIX_NAME + VALID_NAME_PERSON_BOB;
    public static final String PHONE_DESC_PERSON_AMY = " " + PREFIX_PHONE + VALID_PHONE_PERSON_AMY;
    public static final String PHONE_DESC_PERSON_BOB = " " + PREFIX_PHONE + VALID_PHONE_PERSON_BOB;
    public static final String NRIC_DESC_PERSON_AMY = " " + PREFIX_NRIC + VALID_NRIC_PERSON_AMY;
    public static final String NRIC_DESC_PERSON_BOB = " " + PREFIX_NRIC + VALID_NRIC_PERSON_BOB;
    public static final String TYPE_DESC_PERSON_AMY = " " + PREFIX_TYPE + VALID_TYPE_PERSON_AMY;
    ...
    public static final EditCommand.EditPersonDescriptor DESC_PERSON_AMY;
    public static final EditCommand.EditPersonDescriptor DESC_PERSON_BOB;

    static {
        DESC_PERSON_AMY = new EditPersonDescriptorBuilder().withType("doctor").withNric(VALID_NRIC_PERSON_AMY)
                .withName(VALID_NAME_PERSON_AMY).withPhone(VALID_PHONE_PERSON_AMY).build();
        DESC_PERSON_BOB = new EditPersonDescriptorBuilder().withType("patient").withNric(VALID_NRIC_PERSON_BOB)
